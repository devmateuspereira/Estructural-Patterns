...
public class Bank implements BankOperations {
    ...
    public void deposit(Long account, Long amount) {
        ...
        System.out.println(String.format("%s +%d. New Balance: %d", user.getName(), amount, user.getBalance()));
    }
    ...
    public void changePassword(Long account, String oldPassword, String newPassword) {
        ...
        System.out.println(String.format("%s's password updated successfully!", user.getName()));
    }
